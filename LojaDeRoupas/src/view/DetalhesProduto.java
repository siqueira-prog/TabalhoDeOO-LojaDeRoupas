...
public class DetalhesProduto implements ActionListener {
    ...
    private static JTextField fieldNome = new JTextField("Kong Wars Zone");

    // Input tamanho
    private static JLabel labelTamanho = new JLabel("Tamanho");
    private static JTextField fieldTamanho = new JTextField("M");

    // Input cor
    private static JLabel labelCor = new JLabel("Cor:");
    private static JTextField fieldCor = new JTextField("Vermelho");
    ...
    private static JTextField fieldPreco = new JTextField("R$25,50");
    ...
    public void detalharProduto() {
        DetalhesProduto detalharproduto = new DetalhesProduto();
